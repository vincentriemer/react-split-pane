...
var SplitPane = function (_Component) {
    ...
    _createClass(SplitPane, [{
                ...
                if (this.state.active) {
                    ...
                    if (ref) {
                        ...
                        if (node.getBoundingClientRect) {
                            ...
                            var inferredMax = function () {
                                if (_this2.props.split === 'horizontal') {
                                    return _this2.props.height - _this2.props.minSize;
                                }
                                return _this2.props.width - _this2.props.minSize;
                            }();
        ...
        value: function render() {
            ...
            var primarySize = this.state.size;
            var secondarySize = split === 'horizontal' ? height - primarySize - resizerSize : width - primarySize - resizerSize;

            var primaryWidth = void 0,
                primaryHeight = void 0,
                secondaryWidth = void 0,
                secondaryHeight = void 0;
